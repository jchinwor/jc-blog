<template>
    ...
    <div v-show="editPost" class="icons">
        ...
        <router-link :to='{ name: "blog", params: {slug: post.slug, blogid:post.blogID }, props: {blogid: post.blogID} }' class="card-item">
            ...
            <div class="arrow">
                <router-link class="link readmore" :to='{ name: "blog", params: {slug: post.slug, blogid:post.blogID }, props: {blogid: post.blogID} }' ><i class="fas fa-arrow-right card-icon"></i></router-link>
            </div>
        </router-link>
...
<div  v-else class="card-list">
    ...
    <Skeleton width="8rem" borderRadius="16px" class="mb-5"></Skeleton>
